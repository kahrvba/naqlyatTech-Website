    ...
    return (
        <section id="home" className="w-full">
            ...
            <div className='h-[65vh] sm:h-[70vh] md:h-[80vh] w-full'>
                <div className="absolute left-1/2 transform -translate-x-1/2 top-[25%] sm:top-[25%] md:top-[60%] z-30 w-full max-w-7xl px-0 sm:px-10">
                    <div className="flex justify-center md:justify-between items-center">
                        ...
                        <IPhoneMockup
                            ...
                            className="hidden md:block w-1/3 mt-16 z-10"
                        />
                        ...
                        <IPhoneMockup
                            ...
                            className="w-full max-w-[500px] sm:max-w-[400px] md:w-1/3 z-20"
                        />
